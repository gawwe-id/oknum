...
export default function ConsultingPage() {
  return (
    <main className="min-h-screen">
      ...
      <Navbar />
      <Hero
        titlePart1="Tersangka"
        titleHighlight="Kejayaan"
        titlePart2="Brand Kamu"
        description="Kami adalah Creator produk digital berkualitas dengan design yang intuitive dan performa optimal. Solusi digital terbaik untuk kebutuhan bisnis Anda"
        highlightText="Creator produk digital berkualitas"
      />
      <Services />
      {/* <Portfolio /> */}
      {/* <Clients /> */}
