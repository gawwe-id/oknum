...
export const getClasses = query({
  args: {
    ...
    type: v.optional(v.union(v.literal("offline"), v.literal("online"), v.literal("hybrid"))),
...
export const updateClass = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (updates.minStudents !== undefined) updateData.minStudents = updates.minStudents;
